...
export const About = () => {
  ...
  // Ajustamos el párrafo para que tenga exactamente la misma velocidad que el título [0, 0.3]
  const pOpacity = useTransform(scrollYProgress, [0, 0.3], [0, 1]);
  const pTranslateX = useTransform(scrollYProgress, [0, 0.3], [200, 0]);
